      ...
      <div className="auth-panel">
        ...
        <div className="auth-panel__content">
          ...
          <p className="auth-panel__desc">
            Accede a tu cuenta para continuar gestionando tus finanzas personales de manera organizada.
          </p>
        </div>

        <div className="auth-panel__quote">
          <p className="auth-panel__quote-text">
            "Tener el control de mis gastos nunca fue tan sencillo. Recomiendo esta herramienta a todos."
          </p>
